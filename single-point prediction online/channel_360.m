% clc;
% clear;
% train_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'A:A');
% validation_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'B:B');
% test_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'C:C');
% train_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'D:D');
% validation_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'E:E');
% total_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'F:F');
% test_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'G:G');
% train_prediction_pre = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'H:H');
% validation_prediction_pre = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_360_4800_1600_1600.xlsx', 'I:I');
% real_total = load('channel_data_360_10.mat');
...
grid on
xlabel('Pre-training and IL step, v=360 km/h')
ylabel('|h_{3}(t)|')
