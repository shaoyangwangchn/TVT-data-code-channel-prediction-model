% clear;
% clc;
% train_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'A:A');
% validation_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'B:B');
% test_loss = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'C:C');
% train_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'D:D');
% validation_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'E:E');
% total_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'F:F');
% test_prediction = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'G:G');
% train_prediction_pre = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'H:H');
% validation_prediction_pre = xlsread('E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_20.xlsx', 'I:I');
...
% hold on
% t_train_prediction_pre = 21:train_end;
% plot(t_train_prediction_pre, train_prediction_pre, 'LineWidth', 1.25);
% hold on
% t_validation_prediction_pre = train_end+1:validation_end;
% plot(t_validation_prediction_pre, validation_prediction_pre, 'LineWidth', 1.25);
...
% % error_train_pre = zeros(1, train_end-5);
% % error_validation_pre = zeros(1:validation_end-train_end);
% t_error_train_pre = 21:train_end;
% t_error_validation_pre = train_end+1:validation_end;
% t_error_test_IL = validation_end+1:8000;
% t_error_total = 21:8000;
% error_train_pre = train_prediction_pre - real_total(21: train_end)';
...
% error_total = total_prediction - real_total(21:8000)';
% scatter(t_error_train_pre, error_train_pre, '.');
% hold on 
% scatter(t_error_validation_pre, error_validation_pre, '.');
% hold on 
