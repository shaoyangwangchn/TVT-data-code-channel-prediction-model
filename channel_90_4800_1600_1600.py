...
book = load_workbook(filename=r"E:\PHD\0论文\0论文\TVT_2018\code\time series prediction_CSDN\single-point prediction online\prediction_90_4800_1600_1600.xlsx")
...
dataFile = 'channel_data_90_10.mat'
...
with tf.Session() as sess:
    ...
    # 先重复训练
    # train_loss_return = np.zeros(iter_time)
    train_loss_return = []
    validation_loss_return = np.zeros(iter_time)
    test_loss_return = []
    # test_loss_return = np.zeros(iter_time)
    ...
    for i in range(iter_time):
        ...
        # test_loss_return[i] = test_loss
        print('iter:', i, 'train_loss:', train_loss, 'validation_loss', validation_loss)

    # 这里先给出预训练模型在训练集和验证集上的表现
    ...
    # test_loss_return = []
    for i in range(validation_end-time_step+1, data_num-time_step, prediction_length1):
...
wb.save(filename="prediction_90_4800_1600_1600.xlsx")
